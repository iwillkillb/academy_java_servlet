...
<h3>EL에서 내장객체인 request에 추가된 객체를 추출</h3>
<pre>
...
3. \${stars[2]} = ${stars[2]}   requestScope를 생략가능. 다른 내장객체에 동일한 이름(stars)이 attribute로 추가되지 않았으면.
4. \${stars["3"]} = ${stars["3"]}
...
<h3>scriptlet, expression Tag로 추출시</h3>
<%
...
<h3>scriptlet, expression Tag로 맵 추출</h3>
<%
	// request 객체에서 attribute를 추출(getAttribute() 메소드 사용)
